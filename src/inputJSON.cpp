...
void configPorConsola(string path){
 ...
 int verificacion;
    ...
    cout<< "ingrese 1 si quiere usar el json ya definido, sino ingrese otro numero para configurar el JSON."<<endl;
    cin>> verificacion;
    if(verificacion==1){
        return;
    }
    ...
    cout << "Ingrese los valores de la matriz de ancho de banda (" 
         << cantidadRouters << "x" << cantidadRouters << ") (usa -1 si no hay conexión):" << endl;
